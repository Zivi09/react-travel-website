      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Maharashtra, Mumbai, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:pereirazivencs232417@gmail.com" className="d-block" >pereirazivencs232417@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:12345678" className="d-block" >12345678</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Ziven All rights reserved </p> 
        </Col>
        </Row>
